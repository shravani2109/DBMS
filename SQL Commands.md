...
<!-- saved from url=(0064)http://127.0.0.1:8080/apex/f?p=4500:1003:6424088726528808::NO::: -->
...
<script src="./SQL Commands_files/htmldb_html_elements.js.download" type="text/javascript"></script>
<script src="./SQL Commands_files/htmldb_get.js.download" type="text/javascript"></script>
...
<link rel="stylesheet" href="./SQL Commands_files/core.css" type="text/css">
<style type="text/css">
<!-- 
...
var pCall="sc_getResults('6424088726528808')";
...
<link rel="stylesheet" href="./SQL Commands_files/htmldb_V2.css" type="text/css">
<script src="./SQL Commands_files/sc_slider.js.download" type="text/javascript"></script>
<script src="./SQL Commands_files/sc_core.js.download" type="text/javascript"></script>
...
<body onload="first_field(); sc_PageInit()" onbeforeunload="sc_removeJob()" style="cursor: default;"><noscript>You must run this product with JavaScript enabled.</noscript><form action="http://127.0.0.1:8080/apex/wwv_flow.accept" method="post" name="wwv_flow" id="wwvFlowForm">
  <input type="hidden" name="p_flow_id" value="4500" id="pFlowId">  <input type="hidden" name="p_flow_step_id" value="1003" id="pFlowStepId">  <input type="hidden" name="p_instance" value="6424088726528808" id="pInstance">  <input type="hidden" name="p_page_submission_id" value="10345" id="pPageSubmissionId">  <input type="hidden" name="p_request" value="" id="pRequest"><a name="PAGETOP"></a><script language="JavaScript" type="text/javascript"> 
var g_Saved="Query Saved.";
var gUser="SYSTEM";
</script>
<a id="htmldbLogo2" href="http://127.0.0.1:8080/apex/f?p=4500:1000:6424088726528808"><img src="./SQL Commands_files/oracle_xe_logo.gif" width="300" height="30" alt="Application Express"></a><a href="javascript:popupURL(&#39;wwv_flow_help.show_help?p_lang=en-us&amp;p_session=6424088726528808&amp;p_flow_id=4500&amp;p_step_id=1003&#39;);" class="htmldbNavLink"><img src="./SQL Commands_files/navbar_help.gif" alt="Task Help" class="htmldbNavLink">Help</a><a href="http://127.0.0.1:8080/apex/wwv_flow_custom_auth_std.logout?p_this_flow=4500&amp;p_next_flow_page_sess=4550:8:6424088726528808" class="htmldbNavLink"><img src="./SQL Commands_files/navbar_logout.gif" alt="Logout" class="htmldbNavLink">Logout</a><a href="http://127.0.0.1:8080/apex/f?p=4500:1000:6424088726528808:::::" class="htmldbNavLink"><img src="./SQL Commands_files/navbar_home.gif" alt="Home" class="htmldbNavLink">Home</a>
...
<tbody><tr>
<td class="htmldbBreadcrumbRegion"><div class="htmldbBreadcrumbs"><a href="http://127.0.0.1:8080/apex/f?p=4500:1000:6424088726528808::NO:::" class="htmldbBreadcrumb">Home</a><span class="htmldbBreadcrumbSep">&gt;</span><a href="http://127.0.0.1:8080/apex/f?p=4500:3002:6424088726528808::NO:::" class="htmldbBreadcrumb">SQL</a><span class="htmldbBreadcrumbSep">&gt;</span><span class="htmldbBreadcrumb">SQL Commands</span><span id="htmldbCustomize"></span></div></td>
<td rowspan="2" class="htmldbRunEditRegion"><table summary=""><tbody><tr><td nowrap="nowrap" align="right"><label for="P1003_SCHEMA"><a class="htmldbGALabel" href="javascript:popupFieldHelp(&#39;11765804246007547&#39;,&#39;6424088726528808&#39;,&#39;Close&#39;)" tabindex="999">Schema</a></label></td>
...
<tr>
<td id="htmldbRunEditZag"><img src="./SQL Commands_files/1px_trans.gif" alt="" width="1" height="6"></td>
</tr>
</tbody></table><a name="SkipRepNav"></a><div id="htmldbMessageHolder" style="padding:0px;margin:0px;"></div>
<table border="0" cellspacing="0" cellpadding="0" align="center" summary="" id="SqlAndResults" width="100%" style="height: 386.25px; width: 482px;">
<tbody><tr>
<td valign="top">
...
<td width="100%"><table summary=""><tbody><tr><td nowrap="nowrap" align="right"><label for="P1003_AUTOCOMMIT"><a class="htmldbLabelOptional" href="javascript:popupFieldHelp(&#39;136320022504169238&#39;,&#39;6424088726528808&#39;,&#39;Close&#39;)" tabindex="999"></a></label></td>
<td colspan="1" rowspan="1" align="left"><input type="hidden" name="p_arg_names" value="136320022504169238">
<input type="checkbox" name="p_v02" value="Y" checked="checked" onclick="this.blur();" onchange="sc_toggleJob(this);" id="P1003_AUTOCOMMIT_0"><span class="fielddata"><label for="P1003_AUTOCOMMIT_0">Autocommit</label></span>&nbsp;&nbsp;&nbsp;<label for="P1003_ROWS"><a class="htmldbGALabel" href="javascript:popupFieldHelp(&#39;138940226594571588&#39;,&#39;6424088726528808&#39;,&#39;Close&#39;)" tabindex="999">Display</a></label><input type="hidden" name="p_arg_names" value="138940226594571588">
...
<div id="scCommandHolder" class="d1" style="height: 190.125px; width: 482px; overflow: hidden;"><textarea name="p_t04" cols="30" rows="4" wrap="virtual" id="P1003_SQL_COMMAND1" style="width: 482px; height: 180px;"></textarea><table summary=""><tbody><tr><input type="hidden" name="p_arg_names" value="1010404642163039">

</tr></tbody></table>
</div>
<div id="h_slide" style="width: 482px;"><br></div>
<div id="scBottomHolder" style="width: 482px;"><table class="htmldbTabbedNavigationList" border="0" cellpadding="0" cellspacing="0"><tbody><tr>

<td valign="bottom"><a href="http://127.0.0.1:8080/apex/f?p=4500:1003:6424088726528808::NO:::#" class="tabcurrent" id="result_tab" onclick="html_TabClick(this,&#39;resultsHolder&#39;);return false;">Results</a></td>

<td valign="bottom"><a href="http://127.0.0.1:8080/apex/f?p=4500:1003:6424088726528808::NO:::#" id="explain_tab" onclick="sc_getPlan();html_TabClick(this,&#39;explainHolder&#39;);return false;" class="">Explain</a></td>
<td valign="bottom"><a href="http://127.0.0.1:8080/apex/f?p=4500:1003:6424088726528808::NO:::#" id="describe_tab" onclick="sc_getDesc();html_TabClick(this,&#39;describeHolder&#39;);return false;" class="">Describe</a></td>
<td valign="bottom"><a href="http://127.0.0.1:8080/apex/f?p=4500:1003:6424088726528808::NO:::#" id="savedsql_tab" onclick="sc_getSavedSQL();html_TabClick(this,&#39;SavedSQLHolder&#39;);return false;" class="">Saved SQL</a></td>
<td valign="bottom"><a href="http://127.0.0.1:8080/apex/f?p=4500:1003:6424088726528808::NO:::#" id="history_tab" onclick="sc_DisplayHist();html_TabClick(this,&#39;historyHolder&#39;);return false;" class="">History</a></td>
<td width="100%"><br></td></tr></tbody></table>
<div id="htmlTabHolder" style="width: 482px;"><div id="resultsHolder" class="fielddata" style=""><div id="BOX_BODY"><table summary=""><input type="hidden" name="p_arg_names" value="4417028828681705">
<input type="hidden" name="p_t01" value="0" id="P1200_ROWS">
<input type="hidden" name="p_arg_names" value="4418303464693368">
<input type="hidden" name="p_t02" value="SELECT b.RoomNo,b.Bed_No 
FROM Patient p
JOIN Bed b ON p.Bed_No = b.Bed_No
WHERE p.PName = &#39;Mr Ajay&#39;;" id="P1200_PREV_SQL">
...
<div id="ResultsSQL">
<table summary="" cellpadding="0" cellspacing="0" border="0" class="htmldbMinReport">
<tbody><tr><th>ROOMNO</th><th>BED_NO</th></tr>
<tr><td>101</td><td>1</td></tr>
</tbody></table>
</div>
<table><tbody><tr><td><span style="font-size:13px">1 rows returned in                0.00 seconds</span></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><span style="font-size:11px"><a href="http://127.0.0.1:8080/apex/f?p=4500:1204:6424088726528808::::P1204_BROWSER_LANG:en-us">CSV Export</a></span></td></tr></tbody></table><table class="htmldbShowHide" cellpadding="0" cellspacing="0" border="0" summary="" id="R137341724550811368">
<thead id="headR137341724550811368">
<tr>
<th class="htmldbShowHide"><span onclick="htmldb_ToggleTableBody(&#39;iR137341724550811368&#39;,&#39;bodyR137341724550811368&#39;)"><img src="./SQL Commands_files/rollup_plus_dgray.gif" class="pseudoButtonActive" id="iR137341724550811368" alt="">DBMS Output</span></th>
</tr>
</thead>
...
pUrl += "&p_session_id=" + escape('6424088726528808');
...
<input type="hidden" name="p_t05" value="SELECT b.RoomNo,b.Bed_No 
FROM Patient p
JOIN Bed b ON p.Bed_No = b.Bed_No
WHERE p.PName = &#39;Mr Ajay&#39;;" id="P1003_SQL_COMMAND2">
...
<table style="position: absolute; background-color: rgb(238, 238, 238); border: 1px solid rgb(0, 0, 0); padding: 0px; text-align: center; font-size: 12px; color: rgb(0, 0, 0); top: 40%; left: 40%;" summary="" cellpadding="0" cellspacing="0" border="0" id="R6464923591877238">
<tbody><tr>
<td class="htmldbWizardHeader">Save SQL</td>
<td class="htmldbWizardHeader" align="right"><span onclick="dhtml_CloseDialog(this);"><img src="./SQL Commands_files/vertical_close.png"></span></td>
</tr>
<tr>
<td colspan="2" class="htmldbWizardBody"><div id="saveDialog"><table summary=""><tbody><tr><td nowrap="nowrap" align="right"><label for="P1003_SAVE_NAME"><a class="htmldbLabelRequired" href="javascript:popupFieldHelp(&#39;6470812902902555&#39;,&#39;6424088726528808&#39;,&#39;Close&#39;)" tabindex="999"><img src="./SQL Commands_files/requiredicon_status2.gif" alt="">Name</a></label></td>
...
</td></tr><tr><td nowrap="nowrap" align="right" valign="top"><label for="P1003_SAVE_DESC"><a class="htmldbLabelOptional" href="javascript:popupFieldHelp(&#39;6471725716906222&#39;,&#39;6424088726528808&#39;,&#39;Close&#39;)" tabindex="999">Description</a></label></td>
